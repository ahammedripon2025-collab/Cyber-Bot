...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var tl = ["🌻🌺💚-আসসালামু আলাইকুম ওয়া রাহমাতুল্লাহ-💚🌺🌻","- ভালোবাসা নামক আব্লামি করতে মন চাইলে আমার বস রিপন এর ইনবক্স চলে যাও-🙊🥱👅 🌻𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊 𝐈𝐃 𝐋𝐈𝐍𝐊 🌻:- https://www.facebook.com/share/1HhH6jJ2km/"     ,"হ্যা বলো 😊 " ];
  ...
  if ((event.body.toLowerCase() == "ripon") || (event.body.toLowerCase() == "Ripon") || (event.body.toLowerCase() == "@Riponッ") || (event.body.toLowerCase() == "রিপন")) {
   ...
   if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "ceo")) {
     return api.sendMessage("‎[𝐎𝐖𝐍𝐄𝐑:☞ RIPON ッ ☜\n𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 ripon.\n𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝 :- https://www.facebook.com/riponahammed01\nতার সাতে যোগা যোগ করবেন WhatsApp :- +0198036***", threadID);
   };

   if ((event.body.toLowerCase() == "Tor boss ke") || (event.body.toLowerCase() == "admin ke ")) {
     return api.sendMessage("My Creator:Shahariyar Islam Ripon ❤️ হাই আমি মেছেন্জার ROBOT  আামার বস রিপন আমাকে প্রোগ্রাম করেছেন আপনাদের কে হাসানোর জন্য আমি চাই আপনারা সব সময় হাসি খুশি থাকেন", threadID);
   };

  if ((event.body.toLowerCase() == "admin") || (event.body.toLowerCase() == "boter admin")) {
     return api.sendMessage("He is Ripon❤️ তাকে সবাই রিপন নামে  চিনে🤙", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "আসসালামু আলাইকুম") || (event.body.toLowerCase() == "Assalamualaikum") || (event.body.toLowerCase() == "Assalamu alaikum") || (event.body.toLowerCase() == "Salam ")) {
   ...
   if ((event.body.toLowerCase() == "@Tas Nia") || (event.body.toLowerCase() == "@Tas Nia ")) {
     return api.sendMessage("খবরদার কেউ এই আইড়ি মেনশন দিবানা এটা আমার বস রিপন এর ক্রাশ এর আইডি😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "Tas Nia") || (event.body.toLowerCase() == "Tas Nia")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার বস রিপন এর ক্রাশ এর নাম..!😠🥰⛏️", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "@Md Kawsar ") || (event.body.toLowerCase() == "কাউছার")) {
     return api.sendMessage("🥰-কাউছার🌺 আমার বস রিপন এর বন্ধু লাগে লুচ্ছি বেডি'রা দূরে থাক😠🥰⛏️", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "tnx") || (event.body.toLowerCase() == "ধন্যবাদ") || (event.body.toLowerCase() == "thank you") || (event.body.toLowerCase() == "thanks")) {
     return api.sendMessage("️এতো ধন্যবাদ না দিয়ে পারলে বয়ফ্রেন্ড টা দিয়ে দে..!🌚⛏️🌶️", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "Name") || (event.body.toLowerCase() == "name") || (event.body.toLowerCase() == "Tor nam ki")) {
     return api.sendMessage("️MY NAME IS °_>Alya Russian", threadID);
   };

   if ((event.body.toLowerCase() == "BOT ER BACCHA") || (event.body.toLowerCase() == "Bot er bacca")) {
     return api.sendMessage("️তুমার বাচ্চা তো আমার পেটে..!!🌚⛏️🌶️ ", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "Mukta") || (event.body.toLowerCase() == "ex")) {
   ...
   if ((event.body.toLowerCase() == "ami ripon") || (event.body.toLowerCase() == "kire")) {
